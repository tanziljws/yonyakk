...
<html>
<head>
    <title>Edit Konten - SMK Negeri 4</title>
    <meta charset="UTF-8">
        ...
        <div class="main-content">
            ...
            <div class="content-header">
                <div class="header-left">
                    ...
                    <p class="page-subtitle">Edit konten: {{ $content->title }}</p>
                </div>
                ...
                <div class="form-container">
                    <div class="form-card">
                        <div class="card-header">
                            <h5><i class="bi bi-pencil-square"></i> Form Edit Konten</h5>
                        </div>
                        <div class="card-body">
                            @if($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="content" name="content" rows="10">{{ old('content', $content->content) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="type" name="type" required>
                                                ...
                                                <option value="homepage" {{ old('type', $content->type) == 'homepage' ? 'selected' : '' }}>Halaman Utama</option>
                                                <option value="about" {{ old('type', $content->type) == 'about' ? 'selected' : '' }}>Tentang Kami</option>
                                                <option value="contact" {{ old('type', $content->type) == 'contact' ? 'selected' : '' }}>Kontak</option>
                                                <option value="news" {{ old('type', $content->type) == 'news' ? 'selected' : '' }}>Berita</option>
                                                <option value="announcement" {{ old('type', $content->type) == 'announcement' ? 'selected' : '' }}>Pengumuman</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ old('status', $content->status) ? 'checked' : '' }}>
