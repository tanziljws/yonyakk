...
<html>
<head>
    <title>Tambah Konten - SMK Negeri 4</title>
    <meta charset="UTF-8">
        ...
        <div class="main-content">
            ...
            <div class="content-header">
                <div class="header-left">
                    <h1 class="page-title">Tambah Konten</h1>
                    <p class="page-subtitle">Tambah konten baru untuk website sekolah</p>
                </div>
                ...
                <div class="form-container">
                    <div class="form-card">
                        <div class="card-header">
                            <h5><i class="bi bi-plus-circle"></i> Form Tambah Konten</h5>
                        </div>
                        <div class="card-body">
                            @if($errors->any())
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="type" name="type" required>
                                                ...
                                                <option value="homepage" {{ old('type') == 'homepage' ? 'selected' : '' }}>Halaman Utama</option>
                                                <option value="about" {{ old('type') == 'about' ? 'selected' : '' }}>Tentang Kami</option>
