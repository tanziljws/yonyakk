...
<html>
<head>
    <title>Tambah Informasi - SMK Negeri 4</title>
    <meta charset="UTF-8">
        ...
        <div class="main-content">
            ...
            <div class="content-header">
                <div class="header-left">
                    ...
                    <p class="page-subtitle">Tambah informasi baru untuk sekolah</p>
                </div>
                ...
                <div class="form-container">
                    <div class="form-card">
                        <div class="card-header">
                            <h5><i class="bi bi-plus-circle"></i> Form Tambah Informasi</h5>
                        </div>
                        <div class="card-body">
                            @if($errors->any())
